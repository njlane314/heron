                       ...
                       bool draw_planes = true)
{
  ...
  auto n = node
               .Define("n_pix_u", [](const auto &v) { return static_cast<int>(v.size()); }, {"detector_image_u"})
               .Define("n_pix_v", [](const auto &v) { return static_cast<int>(v.size()); }, {"detector_image_v"})
               .Define("n_pix_w", [](const auto &v) { return static_cast<int>(v.size()); }, {"detector_image_w"})
