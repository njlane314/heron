...
INCLUDES = -I./io/include -I./sample/include -I./rdf/include -I./ana/include -I./apps/include
...
$(SAMPLE_LIB_NAME): $(SAMPLE_OBJ)
	mkdir -p $(dir $(SAMPLE_LIB_NAME))
	$(CXX) -shared $(CXXFLAGS) $(SAMPLE_OBJ) $(LDFLAGS) -o $(SAMPLE_LIB_NAME)
...
$(RDF_BUILDER_NAME): $(RDF_BUILDER_SRC) $(IO_LIB_NAME) $(SAMPLE_LIB_NAME) $(RDF_LIB_NAME) \
	$(ANA_LIB_NAME)
...
$(ART_AGGREGATOR_NAME): $(ART_AGGREGATOR_SRC) $(IO_LIB_NAME) $(SAMPLE_LIB_NAME)
	mkdir -p $(dir $(ART_AGGREGATOR_NAME))
	$(CXX) $(CXXFLAGS) $(INCLUDES) $(ART_AGGREGATOR_SRC) -Lbuild/lib -lNuxsecIO -lNuxsecSample \
		$(LDFLAGS) -o $(ART_AGGREGATOR_NAME)

$(SAMPLE_AGGREGATOR_NAME): $(SAMPLE_AGGREGATOR_SRC) $(IO_LIB_NAME) $(SAMPLE_LIB_NAME)
	mkdir -p $(dir $(SAMPLE_AGGREGATOR_NAME))
	$(CXX) $(CXXFLAGS) $(INCLUDES) $(SAMPLE_AGGREGATOR_SRC) -Lbuild/lib -lNuxsecIO -lNuxsecSample \
